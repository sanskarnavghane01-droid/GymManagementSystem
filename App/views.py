...
def add_member(request):
    if request.method == "POST":
        ...
        membership_plan = MembershipPlan.objects.get(id=request.POST.get("membership_plan"))
...
def edit_member(request, id):
    ...
    if request.method == "POST":
        ...
        member.membership_plan = MembershipPlan.objects.get(id=request.POST.get("membership_plan"))
